...
public data class InfoSensorFragmentWearOsArgs(
  ...
  public companion object {
    @JvmStatic
    public fun fromBundle(bundle: Bundle): InfoSensorFragmentWearOsArgs {
      bundle.setClassLoader(InfoSensorFragmentWearOsArgs::class.java.classLoader)
      val __type : String?
      ...
      return InfoSensorFragmentWearOsArgs(__type)
    }

    @JvmStatic
    public fun fromSavedStateHandle(savedStateHandle: SavedStateHandle):
        InfoSensorFragmentWearOsArgs {
      val __type : String?
