 ...
 */
public abstract class Hilt_InfoSensorFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_InfoSensorFragment() {
    super();
  }

  Hilt_InfoSensorFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((InfoSensorFragment_GeneratedInjector) this.generatedComponent()).injectInfoSensorFragment(UnsafeCasts.<InfoSensorFragment>unsafeCast(this));
    }
  }
