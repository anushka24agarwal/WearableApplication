 ...
 */
public abstract class Hilt_InfoSensorFragmentWearOs extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_InfoSensorFragmentWearOs() {
    super();
  }

  Hilt_InfoSensorFragmentWearOs(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((InfoSensorFragmentWearOs_GeneratedInjector) this.generatedComponent()).injectInfoSensorFragmentWearOs(UnsafeCasts.<InfoSensorFragmentWearOs>unsafeCast(this));
    }
  }
