 ...
 */
public abstract class Hilt_ExtraFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ExtraFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ExtraFragment_GeneratedInjector) this.generatedComponent()).injectExtraFragment(UnsafeCasts.<ExtraFragment>unsafeCast(this));
    }
  }
